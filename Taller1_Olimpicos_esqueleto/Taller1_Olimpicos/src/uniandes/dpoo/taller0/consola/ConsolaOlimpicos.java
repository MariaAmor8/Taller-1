...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pais de determinado atleta\n");
	...
	{	
		String nombr = input("Ingrese el nombre del atleta que le interesa");
		String resultado = calculadora.PaisPorAtleta(nombr);
		if (resultado == "")
		{
			System.out.println("No se encontró un atleta con el nombre " + nombr);
		}
		else {
			System.out.println("El/La atleta "+nombr+" representa a " +resultado);
		}
	}
