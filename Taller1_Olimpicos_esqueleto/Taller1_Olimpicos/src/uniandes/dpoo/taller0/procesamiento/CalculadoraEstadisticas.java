...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Nueva función que estoy intentando hacer sin llorar :D
	 * 
	 * @param nombre del atleta
	 * @return país al que pertenece
	 */
	public String PaisPorAtleta(String nombr)
	{
		String rta = "";

		for (Atleta unAtleta : atletas)
		{
			if (unAtleta.darNombre().equals(nombr))
			{
				rta = unAtleta.darPais().darNombre();
			}
		}
